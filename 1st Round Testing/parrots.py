...
def PARROTS(t, v, parrotee_percent, parroter_percent):
    ...
    for ti in range(t): # move vehicles to nearby coordinates on road grid
        ...
        if ((ti+1) % 100) == 0:                 # on last iteration print output
            ...
            #Added stat trackers, to get the metrics, other code is unchanged - PD
...
#   Main
# ----------------------------------------------------------------------------- #
print (PARROTS(2000,2400,0,0))
print ("###############################################")
print (PARROTS(2000,2800,0,0))
print ("###############################################")
print (PARROTS(2000,3200,0,0))
print ("###############################################")
print (PARROTS(2000,3600,0,0))
print ("###############################################")
print (PARROTS(2000,4000,0,0))
