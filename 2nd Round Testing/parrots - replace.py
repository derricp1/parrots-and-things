        ...
        for vi in range(v):
            ...
            if x[vi] % 100 == 0: # if vehicle is on vertical road stay vertical
                ...
                if y[vi] + ydir[vi] * increment > ymax:
                    ...
                    if vi % 2 == 0: # if vi is even, let x be an even 100 and y be random
                        x[vi] = 100*random.randint(0,xmax/100)
                        y[vi] = random.randint(0,ymax)
                    else:
                        x[vi] = random.randint(0,xmax)
                        y[vi] = 100*random.randint(0,ymax/100)
                    xprior[vi] = 0
                    yprior[vi] = 0
                    xdir[vi] = -1**random.randint(1,2) # randomly select -1 or 1 
                    ydir[vi] = -1**random.randint(1,2)
                    leader[vi] = -1 # -1 means has not been set
                    anonymity[vi] = -1
                    for ocar in range(v):
                        if leader[ocar] == vi:
                            leader[ocar] = -1
...
#   Main
# ----------------------------------------------------------------------------- #
print (PARROTS(2000,400,0,0))
print ("###############################################")
print (PARROTS(2000,800,0,0))
print ("###############################################")
print (PARROTS(2000,1200,0,0))
print ("###############################################")
print (PARROTS(2000,1600,0,0))
print ("###############################################")
print (PARROTS(2000,2000,0,0))
